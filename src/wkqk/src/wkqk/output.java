...
public class output {
	...
	int outputUSD1 =   (int) ((((((num * 100)/100)%100)%50)%10)%5)/1;        // 1달러까지 구함 
		...
		System.out.println("환전결과 : " 
							+ outputUSD + "달러");                // outputUSD에 저장된 환전되는 총 액수 출력 
		System.out.println("100달러 : " 
							+ outputUSD100 + "장");         // 환전한 돈 중 100달러 몇장이 나오는지 출력 
		System.out.println("50달러 : "  
							+ outputUSD50  + "장");          // 100달러를 제외한 환전한 돈중 50달러 몇장이 나오는지 출력
		System.out.println("10달러 : "  
							+ outputUSD10 + "장");          // 남은 돈중 10달러
	...
	public void change_USD(int b) {                // change_USD 함수 설정 - USD의 잔돈  
		...
		int changeUSD100 = (int) ((b - ((outputUSD * USD)))%500)/100;		// 500으로 나눠주고 남은 돈을 100으로 나눠주면 100원 잔돈이 몇개나오는지 설정됨 
		...
		System.out.println("500원 : "  
							+  changeUSD500 + "개");         // 500원이 잔돈중에 몇개 나오는지 출력 
		System.out.println("100원 : "  
							+ changeUSD100 + "개");           // 500원으로 나눠주고 남은 잔돈중에 100원이 몇개 나오는지 출력
		System.out.println("50원 : "   
							+ changeUSD50 + "개");          // 그렇게 50원 
		System.out.println("10원 : "   
							+ changeUSD10 + "개");           // 10원
		System.out.println("5원 : "    
							+ changeUSD5 + "개");            // 5원 
		System.out.println("1원 : "    
							+ changeUSD1 + "개");              // 1원이 몇개씩 나오는지 다 출력 
	}
	...
	int outputJPY5 =     (int) ((((((((((num2 * 100)/100)%10000)%5000)%2000)%1000)%500)%100)%50)%10)/5;
	int outputJPY1 =     (int) (((((((((((num2 * 100)/100)%10000)%5000)%2000)%1000)%500)%100)%50)%10)%5)/1;
