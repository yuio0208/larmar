...
import java.text.SimpleDateFormat;   // impot로 SimpleDateFormat 클래스 사용 
import java.util.Calendar;   //   impot로 Calendar 클래스 사용 
...
public class work7 {
	...
	public static void main99(String[] args) {
		...
		Calendar kopo05_calt = Calendar.getInstance() ;
		SimpleDateFormat kopo05_sdt = new SimpleDateFormat("YYYY/MM/dd HH:mm:ss");
		System.out.printf("최종실행시간: %s\n", kopo05_sdt.format(kopo05_calt.getTime()));
		System.out.printf("**********************************************************************************\n");
