...
public class F7 {
	...
	public static void main(String[] args) throws IOException {
		...
		File kopo05_f = new File("C:\\Users\\김범주\\Desktop\\download_2021-05-04_17-16-44\\day_data\\THTSKS010H00.dat"); // 읽어올 파일 객체 생성 
		BufferedReader kopo05_br = new BufferedReader(new FileReader(kopo05_f));  // 파일 읽기 객체 생성 

		File kopo05_f1 = new File("C:\\Users\\김범주\\Desktop\\download_2021-05-04_17-16-44\\day_data\\StockDailyPrice.csv"); // 작성할 파일객체 생성 
		BufferedWriter kopo05_bw1 = new BufferedWriter(new FileWriter(kopo05_f1)); // 파일 쓰기 객체 생성 
		...
		while ((kopo05_readtxt = kopo05_br.readLine()) != null) {  // 문서 끝까지 
			...
			String[] kopo05_field = kopo05_readtxt.split("%_%");    // "%_%"로 구분하여 각각의 데이터 배열로 저장 
			...
			if (kopo05_field.length > 2 && kopo05_field[2].replace("^", "").trim().substring(0, 1).equals("A")) { // 특수문자 제거 후 3번째 필드가 A로 시작하는 경우 
				...
				kopo05_bw1.write(kopo05_s.toString()); // 만들어진 한 줄의 데이터를 파일에 작성 
				kopo05_bw1.newLine();   // 개행 
